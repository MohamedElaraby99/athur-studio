...
export const HERO = {
    // العنوان الرئيسي
    mainTitle: "اثر استديو - للطلاب: تجربة تعليمية فريدة ومميزة",
    // العنوان الفرعي
    subtitle: "استمتع بتجربة تعليمية استثنائية مصممة خصيصاً عشان تساعدك تتفوق وتتميز في دراستك",
    // النص أعلى العنوان
    topText: "🎓 منصة تعليمية متكاملة - تجربة فريدة للطلاب",
    // نص زر الاشتراك
    ctaButtonText: "يلا بينا نبدأ رحلتك التعليمية دلوقتي ! 🚀",
    // رابط زر الاشتراك
